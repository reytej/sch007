...
<head>
	...
	<title>Kidscoco  Preschool</title>
...
<body>
	<div id="wrapper" class="homepage">
		<div class="wrapper-holder">
			<header id="header">
				...
				<a id="logo" href="index.html">Kidscoco</a>
						...
						<div class="widget-calendar">
							<table class="event-calendar">
								...
								<tr>
									...
									<th scope="col" colspan="5" class="month">July 2016</th>
									<th scope="col" class="controls"></th>
								</tr>
								<tr>
					...
					<div class="widget-boxes news">
						...
						<div class="box">
							<a class="news-img" href="#">
								<img src="<?php echo base_url(); ?>dist/images/img-news01.jpg" alt="" />
								<div class="mask"></div>
							</a>
							<div class="box-info">
						...
						<div class="box">
							<a class="news-img" href="#">
								<img src="<?php echo base_url(); ?>dist/images/img-news02.jpg" alt="" />
								<div class="mask"></div>
							</a>
							<div class="box-info">
						...
						<div class="box">
							<a class="news-img" href="#">
								<img src="<?php echo base_url(); ?>dist/images/img-news03.jpg" alt="" />
								<div class="mask"></div>
							</a>
							<div class="box-info">
	...
	<script type="text/javascript" src="<?php echo base_url(); ?>dist/js/jquery.bxslider.min.js"></script>
	<script type="text/javascript" src="<?php echo base_url(); ?>dist/js/jquery.placeholder.js"></script>
	<script type="text/javascript" src="<?php echo base_url(); ?>dist/js/main.js"></script>
</body>
</html>